...
import transcribe_pro_v5_branch_04_branch_69 as backend_task
...
#  全域設定與常數
# ==============================================================================
CORE_SCRIPT_NAME = "transcribe_pro_v5_branch_04_branch_69.py"
...
class TranscriptionApp:
    def __init__(self, master):
        ...
        self.master.title(f"AI 字幕轉錄工具 v2.81 (核心: {CORE_SCRIPT_NAME})")
    ...
    def _create_widgets(self):
        ...
        self.toolbox_section = CollapsibleFrame(main_frame, text="工具箱｜指定時段轉錄 / 補翻 (點擊 ▶ 展開)", expanded=False)
        ...
        self.api_key_var = tk.StringVar(); self.model_name_var = tk.StringVar(value="models/gemini-2.5-pro"); self.chunk_duration_var = tk.StringVar(value="600")
